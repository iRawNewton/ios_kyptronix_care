...
class VideoEditorDev extends StatefulWidget {
  const VideoEditorDev(
      {super.key,
      required this.devId,
  ...
  @override
  State<VideoEditorDev> createState() => _VideoEditorDevState();
}

class _VideoEditorDevState extends State<VideoEditorDev> {
          ...
          child: Column(
            children: [
              ...
              MyDevEmailWidget(
                  ...
                  hintText: 'No. of Project Management',
                  infoText: 'Number of project managed'),

              // Progress towards project goals
              MyDevEmailWidget(
                  controller: progressText,
                  hintText: 'Business Name',
                  infoText: 'Name of business worked for'),

              // collaborations and communications
              MyDevEmailWidget(
                  controller: collaborationText,
                  hintText: 'Script',
                  infoText: 'Provide script details'),

              // next steps
              MyDevEmailWidget(
                  controller: nextStepText,
                  hintText: 'Duration',
                  infoText: 'Duration of work done'),

              // opportunities for improvement
              MyDevEmailWidget(
                  controller: opportunityText,
                  hintText: 'Number of videos till date',
                  infoText: 'Number of videos worked till date'),
