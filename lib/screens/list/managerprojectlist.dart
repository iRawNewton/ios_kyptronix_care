import 'dart:convert';
import 'package:ios_kyptronix_care/screens/assignproject/pm/assign_project.dart';
...
class MyPmProjectList extends StatefulWidget {
  const MyPmProjectList({super.key});

  @override
  State<MyPmProjectList> createState() => _MyPmProjectListState();
}

class _MyPmProjectListState extends State<MyPmProjectList> {
  ...
  Future getProjectList() async {
    ...
    var response = await http.post(
      Uri.parse('$tempUrl/projectmanager/projectlistPm.php'),
      body: {
        'pm_id': pmId,
      },
    );
  ...
  searchClientList(queryValue) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? pmID = prefs.getString('pmId');

    var response = await http.post(
      Uri.parse('$tempUrl/projectmanager/searchClientManager.php'),
      body: {
        'managerId': pmID,
                                                              ...
                                                              showCupertinoDialog(
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return CupertinoAlertDialog(
                                                                    title: Text(
                                                                      'Delete client ${data[index]['proj_name']}',
